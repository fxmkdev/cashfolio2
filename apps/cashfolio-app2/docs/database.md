...
- `prisma generate` works without `DATABASE_URL`; config provides a generate-only
  fallback URL so unit-test and Storybook workflows do not need manual env setup
