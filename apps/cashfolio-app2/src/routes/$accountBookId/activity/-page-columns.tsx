...
export function useActivityColumnDefs(args: {
  ...
  return useMemo<ColDef<ActivityRow>[]>(() => {
    ...
    return [
      ...
      },
      {
        ...
        cellRenderer: ({
          value,
          data,
        }: ICellRendererParams<ActivityRow, ActivityRow["account"]>) => {
      ...
      },
      {
        ...
        width: 130,
        filter: true,
        valueGetter: ({ data }: { data?: ActivityRow }) => {
          if (!data) return null;
          switch (data.unit) {
            case Unit.CURRENCY:
      ...
      },
      {
        ...
        cellRenderer: ({ data }: ICellRendererParams<ActivityRow>) => {
          if (!data) return null;
